...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        quiz = Quiz.objects.get(title="Xinhai Revolution")
        with open("XinhaiRev.txt", "r") as file:
        ...
        self.stdout.write(self.style.SUCCESS("Xinhai Revolution questions added successfully!"))
