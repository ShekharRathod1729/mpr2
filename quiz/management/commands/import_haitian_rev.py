...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        quiz = Quiz.objects.get(title="Haitian Revolution")
        with open("HaitianRev.txt", "r") as file:
        ...
        self.stdout.write(self.style.SUCCESS("Haitian Revolution questions added successfully!"))
