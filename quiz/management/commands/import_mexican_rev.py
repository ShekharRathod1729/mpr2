...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        quiz = Quiz.objects.get(title="Mexican Revolution")
        with open("MexicanRev.txt", "r") as file:
        ...
        self.stdout.write(self.style.SUCCESS("Mexican Revolution questions added successfully!"))
